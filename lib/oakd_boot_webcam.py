...
# in our case we should be able to run this with the -l option so that we exit out of the script and have the webcam do its thing
...
if args.load_and_exit:
    ...
    print(
        "To reconnect with depthai, a device power-cycle may be required in some cases"
    )
